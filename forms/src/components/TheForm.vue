<template>
    <form @submit.prevent="submitForm">
        <div class="form-control" :class="{ invalid: usernameValidity === 'invalid' }">
            ...
            <p v-if="usernameValidity === 'invalid'" style="color:red;">Input a valid username</p>
        </div>
...
export default defineComponent({
    ...
    methods: {
        submitForm() {
            console.log(this.username, this.age, this.referrer, this.interest, this.how, this.rating)
            this.username = ''
            this.age = null
